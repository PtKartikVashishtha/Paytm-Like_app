...
export const SideBar = () => {
    ...
    return (
        <div className="border-r-3 border-gray-300 w-60 pt-13 min-h-screen">
            ...
            <SideBarComp label={"P2P Transfer"} icon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" 
                stroke="currentColor" className="size-6">
                <path strokeLinecap="round" strokeLinejoin="round" d="M6 12 3.269 3.125A59.769 59.769 0 0 1 21.485 12 59.768 59.768 0 0 1 3.27 
